...
\begin{lstlisting}[caption={}, label={lst:instrumentCFG}, float]
// Input: CFG
instrumentCFG(G) {
...
\begin{lstlisting}[caption={For a given edge, this procedure selects which basic block to place the instrumented code.
                            If the edge is critical, an intermediate basic block is created for the instrumentation.}, label={lst:placeProbe}, float]
