...
\item We adapt the block frequency profiling to measure in order to profile the WP.
\item We propose a relaxed instrumentation for low overhead profiling, with a controlled trade-off between accuracy and overhead.
\item We lower the work profiling futher by performing a whole program relaxation.
