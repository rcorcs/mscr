...
On the other hand, $N_B(i)$ is a program-dependent static value known which is known at compile-time and $f(B)$ is a dynamic value known only at run-time,
...
For this reason, higher IPC does not necessarily translate to shorter execution time.
