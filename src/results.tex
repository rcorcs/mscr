...
The \texttt{adpcm\_d} benchmark is the most critical case amongst the evaluated benchmarks, with an overhead of about 62\% for the optimal instrumentation.
...
\noindent \textbf{Analysis of the Best Improvement: \texttt{adpcm\_d}}
...
\begin{figure*}[htb]
    \centering
    \includegraphics[width=0.8\textwidth]{figs/adpcm_d.png}
    \caption{Comparison between probe frequency and static error for the \texttt{adpcm\_d} benchmark.}
    \label{fig:speedups}
\end{figure*}
...
\begin{figure*}[htb]
    \centering
    \includegraphics[width=0.8\textwidth]{figs/susan_c.png}
    \caption{Comparison between probe frequency and static error for the \texttt{susan\_c} benchmark.}
    \label{fig:speedups}
\end{figure*}
